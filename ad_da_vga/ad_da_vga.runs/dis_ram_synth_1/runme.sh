...
HD_PWD='E:/Downloads/ad_da_hdmi-master/ad_da_vga/ad_da_vga.runs/dis_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dis_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dis_ram.tcl
