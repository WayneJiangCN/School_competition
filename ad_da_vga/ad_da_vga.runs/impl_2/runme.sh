...
HD_PWD='E:/Downloads/ad_da_hdmi-master/ad_da_vga/ad_da_vga.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log hs_ad_da.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hs_ad_da.tcl -notrace
