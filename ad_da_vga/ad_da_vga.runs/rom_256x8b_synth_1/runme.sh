...
HD_PWD='E:/Downloads/ad_da_hdmi-master/ad_da_vga/ad_da_vga.runs/rom_256x8b_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_256x8b.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_256x8b.tcl
