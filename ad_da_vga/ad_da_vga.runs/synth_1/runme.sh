...
HD_PWD='E:/Downloads/ad_da_hdmi-master/ad_da_vga/ad_da_vga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hs_ad_da.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hs_ad_da.tcl
