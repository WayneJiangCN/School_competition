...
HD_PWD='E:/Downloads/ad_da_hdmi-master/ad_da_vga/ad_da_vga.runs/tri_rom_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tri_rom.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tri_rom.tcl
